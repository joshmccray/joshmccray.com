      ...
      <div className="grid md:grid-cols-2 gap-6">
        {previous ? (
          ...
          >
            ...
            <p className="text-xs text-gray-600 line-clamp-2 font-light">{previous.excerpt}</p>
          </Link>
        ) : (
          <div />
        )}
        ...
        {next ? (
          ...
          >
            <div className="flex items-center justify-end gap-2 text-xs text-gray-500 mb-2 font-light">
              <span>Next</span>
              <svg
                className="w-3 h-3"
                fill="none"
            ...
            <p className="text-xs text-gray-600 line-clamp-2 font-light">{next.excerpt}</p>
          </Link>
        ) : (
          <div />
        )}
